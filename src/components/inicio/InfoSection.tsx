...
function InfoSection({ index, slider = false, imgSrc, imgTitle, gallery = [], title, description, button = true, customContent }: InfoSectionProps) {
    return (
        <section className="h-[50dvh] md:min-h-[100dvh] w-full relative">
            ...
            <div className={clsx("xl:w-[20%] lg:w-[30%] md:w-[40%] w-full z-10 p-4 flex flex-col justify-center absolute text-white min-h-full md:min-h-[100dvh] bg-[#0000003d] backdrop-blur-[1px] md:backdrop-blur-md shadow-section gap-10",
